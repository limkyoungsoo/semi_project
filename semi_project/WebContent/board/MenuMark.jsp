				...
				<tbody id="mm">
					<c:forEach items="${requestScope.markList}" var="mark">
						<tr>
							...
							<td><input type="button" value="삭제" class="deleteBtn"><input
								type="hidden" value="${mark.menuVO.menuNo}"></td>
							<td><input type="button" value="이동" class="moveBtn"><input
								type="hidden" value="${mark.storeName}"></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
