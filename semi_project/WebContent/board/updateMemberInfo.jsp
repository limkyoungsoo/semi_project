			...
			<form role="form" id="idForm" action="${pageContext.request.contextPath}/DispatcherServlet">
				<div class="form-group">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="mId" required="required" name="nameId"
						value="${sessionScope.member.mId}" readonly>
					</div>
					<span id="idCheckResult"></span> 
				</div>
				<div class="form-group">
					<label for="InputPassword1">새로운 비밀번호</label> <input type="password"
						class="form-control" id="mPass" placeholder="비밀번호" required="required" name="namePW"
						value="${sessionScope.member.mPass}">
				</div>
				<div class="form-group">
					<label for="username">닉네임</label> <input type="text"
						class="form-control" id="mNick"  required="required" name="nameNick"
						value="${sessionScope.member.mNick }">
				</div>
